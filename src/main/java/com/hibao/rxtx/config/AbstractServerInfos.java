...
public abstract class AbstractServerInfos {
     ...
     */
    public com.hibao.rxtx.config.LicenseExtraModel getServerInfos(){
        com.hibao.rxtx.config.LicenseExtraModel result = new com.hibao.rxtx.config.LicenseExtraModel();
